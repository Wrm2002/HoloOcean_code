...
class RaycastImagingSonar(ImagingSonar):
    """Imaging-style sonar generated from Unreal collision traces.

    Unlike :class:`~holoocean.sensors.ImagingSonar`, this sensor does not depend
    on HoloOcean's static octree representation. It is intended for runtime
    props created with ``env.spawn_prop()`` and other collidable actors.
    """

    sensor_type = "RaycastImagingSonar"

    def __init__(
        self, client, agent_name, agent_type, name="RaycastImagingSonar", config=None
    ):
        super(RaycastImagingSonar, self).__init__(
            client, agent_name, agent_type, name=name, config=config
        )
...
class SensorDefinition:
    ...
    _sensor_keys_ = {
        ...
        "RaycastImagingSonar": RaycastImagingSonar,
